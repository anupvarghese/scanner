...
namespace UHFAPI_NET
{
    ...
    public class UHFAPI_NET
    {
        ...
        ******************************************************************************************************/
        ...
        //┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        internal class UHFMsgWnd : Microsoft.WindowsCE.Forms.MessageWindow
        {
        ...
        {
            bool res = _R900LIB_HWND_EX(uhfmsgwnd.Hwnd, 0, 0);
            return res && _UHFAPI_HWND_EX(uhfmsgwnd.Hwnd, report_mode_set, report_mode_reset);
        }
        ...
        {
            return _UHFAPI_ReadTag(MemBank, offset, length, pwdACCESS, null/*&param*/, wait_done);
        }
        ...
        {
            fixed (UInt16* pszWriteData = &szWriteData[0]) return _UHFAPI_WriteTag(MemBank, offset, length, pszWriteData, pwdACCESS, null/*&param*/, wait_done);
        }
        ...
        {
            return _UHFAPI_LockTag(kill_pwd, access_pwd, epc, tid, user, pwdACCESS, null/*&param*/, wait_done);
        }
        ...
        {
            return _UHFAPI_UnlockTag(kill_pwd, access_pwd, epc, tid, user, pwdACCESS, null/*&param*/, wait_done);
        }
        ...
        {
            return _UHFAPI_PermalockTag(ActionField, Lock, pwdACCESS, null/*&param*/, wait_done);
        }
        ...
        {
            return _UHFAPI_LockSetTag(masks, enables, pwdACCESS, null/*&param*/, wait_done);
        }
        ...
        {
            return _UHFAPI_KillTag(Kill_PWD, pwdACCESS, null/*&param*/, wait_done);
        }
